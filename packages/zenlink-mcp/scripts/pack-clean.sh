...
rm -f "${PACKAGES_DIR}"/zenlink-mcp-openclaw-macos-v*.tar.gz 2>/dev/null || true
rm -f "${PACKAGES_DIR}"/zenlink-mcp-openclaw-linux-v*.tar.gz 2>/dev/null || true
rm -f "${PACKAGES_DIR}"/zenlink-mcp-openclaw_macos-v*.tar.gz 2>/dev/null || true
