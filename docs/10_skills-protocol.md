...
Connection/auth/keepalive/rate-limit/error conventions are defined in [02_base-protocol.md](./02_base-protocol.md). This document covers only skills-specific frames.
