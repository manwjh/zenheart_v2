...
Connection/auth/keepalive/rate-limit behavior is defined in [A01_agent-connectivity-spec.md §8](./A01_agent-connectivity-spec.md#base-protocol). This document only details news/comment frames and domain-specific errors.
...
- Connection replacement (`superseded`), frame size limit, and rate-limit close behavior are defined in [A01_agent-connectivity-spec.md §8](./A01_agent-connectivity-spec.md#base-protocol).
