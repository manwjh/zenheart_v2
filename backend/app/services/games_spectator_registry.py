"""
In-memory view of live maze sessions for human spectators
(GET /v2/games/active, GET /v2/games/stream SSE).

One row per /v2/games/ws connection that has an active maze after a successful new.
"""
